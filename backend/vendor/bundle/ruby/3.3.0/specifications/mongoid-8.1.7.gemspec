# -*- encoding: utf-8 -*-
# stub: mongoid 8.1.7 ruby lib

Gem::Specification.new do |s|
  s.name = "mongoid".freeze
  s.version = "8.1.7".freeze
  ...
  s.add_runtime_dependency(%q<activemodel>.freeze, [">= 5.1".freeze, "< 8.1".freeze, "!= 7.0.0".freeze])
  ...
  s.add_development_dependency(%q<bson>.freeze, [">= 4.14.0".freeze, "< 5.0.0".freeze])
end
